...
typedef enum {
    ...
    PCAP_CHIP_9 = 8,        ///< PCAP chip 1 (mux channel 0)
    PCAP_CHIP_10 = 9,        ///< PCAP chip 2 (mux channel 1)
    PCAP_CHIP_11 = 10,        ///< PCAP chip 3 (mux channel 2)
    PCAP_CHIP_12 = 11,        ///< PCAP chip 4 (mux channel 3)
    PCAP_CHIP_13 = 12,        ///< PCAP chip 5 (mux channel 4)
    PCAP_CHIP_14 = 13,        ///< PCAP chip 6 (mux channel 5)
    PCAP_CHIP_15 = 14,        ///< PCAP chip 6 (mux channel 5)
